...
export default class Tech extends Component {
    constructor(props) {
        super(props);
        console.log("I am tech constructor");
        this.state = {
            articles: [],
            loading: false,
            page: 1,
    ...
    async componentDidMount() {
        let url = "https://newsapi.org/v2/everything?domains=techcrunch.com,thenextweb.com&pageSize=6&apiKey=2bb09eb25bd74ce5a2023ecb3ba8d36a";
