...
import BbcItems from "./BbcItems";
import Spinner from "./Spinner";

export default class Bbc extends Component {
    constructor(props) {
        super(props);
        console.log("I am BBC constructor");
        this.state = {
            articles: [],
            loading: false,
            page: 1,
    ...
    handleNext = async () => {
        ...
        if (this.state.page + 1 > Math.ceil(this.state.totalResults / this.props.pageSize)) {
            ...
            let url = 'https://newsapi.org/v2/top-headlines?sources=bbc-news&pageSize=6&apiKey=2bb09eb25bd74ce5a2023ecb3ba8d36a';
